...
From the main newIris folder, you can run treeIris with
	...
	./bin/treeIris /path/to/your/input-file -c=/path/to/your/config.file -o=/path/to/your/output.file 

or

	./bin/treeIris -c=/path/to/your/config.file --path=/path/to/data/directory --run=run_number -o=/path/to/where/to/store/output/
