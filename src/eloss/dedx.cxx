...
void dedx::makeCatimaTables(int projectileA, int projectileZ, std::string foil, std::string target, double mass)
{
	...
	{
		std::cout << "Warning: Foil Material not found in dedx.cxx!" << std::endl
				  << "Defaulting to Ag." << std::endl;
		foilMat.add_element(107, 47, 1);
	}
	...
	{
		std::cout << "Warning: Target Material " << target << " not found in dedx.cxx!" << std::endl
				  << "Defaulting to H." << std::endl;
		targetMat.add_element(1, 1, 1);
	}
